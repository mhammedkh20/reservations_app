...
class MyTapBarStudent extends StatelessWidget {
  const MyTapBarStudent({
    super.key,
  });
            ...
            children: [
                ...
                child: GestureDetector(
                  onTap: () {
                    StudentAppointmentsCubit.get(context)
                        .changeIndexTapBarStudent(0, context);
                  },
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () {
                    StudentAppointmentsCubit.get(context)
                        .changeIndexTapBarStudent(1, context);
                  },
                  child: MyContainerShape(
                    height: 40.h,
                    bgContainer: index == 1
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () {
                    StudentAppointmentsCubit.get(context)
                        .changeIndexTapBarStudent(2, context);
                  },
                  child: MyContainerShape(
                    height: 40.h,
                    bgContainer: index == 2
