...
import 'package:reservations_app/widgets/bottom_nav_studet_widget.dart';
import 'package:reservations_app/widgets/my_text.dart';
import 'package:shared_preferences/shared_preferences.dart';

class MainStudetScreen extends StatefulWidget {
  const MainStudetScreen({super.key});

  @override
  State<MainStudetScreen> createState() => _MainStudetScreenState();
}

class _MainStudetScreenState extends State<MainStudetScreen> {
  @override
  void initState() {
    AuthCubit.get(context).getDataUser();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          builder: (context, state) {
            ...
            return MyText(
              title: MainCubit.get(context)
                  .itemsStudet(context)[indexSelected]
                  .title,
      ...
      bottomNavigationBar: const BottomNavStudetWidget(),
    );
  }
}
