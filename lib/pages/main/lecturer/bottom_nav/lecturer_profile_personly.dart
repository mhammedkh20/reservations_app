...
class LecturerProfilePersonly extends StatelessWidget {
  ...
  bool loadData = true;
  LecturerProfilePersonly({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                MyText(title: AppLocalizations.of(context)!.jobID),
                ...
                MyTextField(
                  ...
                  textHint: AppLocalizations.of(context)!.jobID,
                ),
